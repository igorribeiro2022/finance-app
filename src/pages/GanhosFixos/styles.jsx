...
export const TotalValue = styled.span`
  ...
  color: ${({ theme, $type }) => $type === 'income' ? theme.colors.success : theme.colors.text};
`;
...
export const AddButton = styled.button`
  ...
  white-space: nowrap;
  &:hover { background: ${({ theme }) => theme.colors.successAlt}; }
`;
...
export const Td = styled.td`
  ...
  font-size: 0.875rem;
  color: ${({ theme, $income }) => $income ? theme.colors.success : theme.colors.text};
  font-weight: ${({ $income }) => $income ? '600' : '400'};
  font-variant-numeric: tabular-nums;
  transition: ${({ theme }) => theme.transition};
`;
...
export const Badge = styled.span`
  ...
  background: rgba(40, 191, 17, 0.12);
...
export const Input = styled.input`
  ...
  &:focus {
    border-color: ${({ theme, $hasError }) => $hasError ? theme.colors.error : theme.colors.success};
    box-shadow: 0 0 0 3px ${({ $hasError }) => $hasError ? 'rgba(217,7,7,0.1)' : 'rgba(40,191,17,0.1)'};
  }
`;
...
export const Select = styled.select`
  ...
  transition: ${({ theme }) => theme.transition};
  cursor: pointer;
  &:focus { border-color: ${({ theme }) => theme.colors.success}; }
`;
...
export const SubmitButton = styled.button`
  ...
  min-width: 130px;
  justify-content: center;
  &:hover:not(:disabled) { background: ${({ theme }) => theme.colors.successAlt}; }
