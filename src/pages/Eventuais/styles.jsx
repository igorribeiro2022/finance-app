...
export const Td = styled.td`
  ...
  font-size: 0.875rem;
  color: ${({ theme, $income, $expense }) =>
    $income ? theme.colors.success : $expense ? theme.colors.error : theme.colors.text};
  font-weight: ${({ $income, $expense }) => ($income || $expense ? '600' : '400')};
  font-variant-numeric: tabular-nums;
...
export const TypeBadge = styled.span`
  ...
  background: ${({ theme, $type }) =>
    $type === 'ganho' ? 'rgba(40, 191, 17, 0.12)' : 'rgba(217, 7, 7, 0.10)'};
  color: ${({ theme, $type }) =>
    $type === 'ganho' ? theme.colors.success : theme.colors.error};
  font-size: 0.75rem;
  font-weight: 700;
`;
...
export const ActionBtn = styled.button`
  ...
  &:hover {
    background: ${({ theme, $danger }) =>
      $danger ? 'rgba(217,7,7,0.08)' : theme.colors.surfaceOffset};
...
export const Input = styled.input`
  ...
  &:focus {
    ...
    box-shadow: 0 0 0 3px ${({ theme, $hasError }) =>
      $hasError ? 'rgba(217,7,7,0.1)' : theme.colors.primaryHighlight};
  }
`;
...
export const DangerBtn = styled.button`
  ...
  &:hover {
    background: ${({ theme }) => theme.colors.errorAlt};
  }
`;
